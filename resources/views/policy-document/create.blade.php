                    ...
                    <div class="card card-default">
                        <div class="card-body">
                            ...
                            if ($tbl_key == LifeInsuranceTraditional::$tablename) {
                                $url = route('insurance-documents-traditional.store',  ['policy_id' => $policy->id, 'tbl_key' => $policy->table]);
                            } else if ($tbl_key == LifeInsuranceUlip::$tablename) {
                                $url = route('insurance-documents-ulip.store',  ['policy_id' => $policy->id, 'tbl_key' => $policy->table]);
                            } else if ($tbl_key == PolicyMaster::$tablename) {
                                $url = route('insurance-documents-general.store',  ['policy_id' => $policy->id, 'tbl_key' => $policy->table]);
                            }
                            ?>
