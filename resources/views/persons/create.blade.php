        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-2">
                <div class="card card-default">
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?= route('person.store', ['client_id' => $client['id']]) ?>">
                            {{ csrf_field() }}
...
$(function(){
    var cleave = new Cleave('#pan_no_div #pan_no', {
        blocks: [10],
        uppercase: true
    });
})
